				...
				<div class="row">
					...
					<label class="col s12 " for="parrafo">Texto</label>
			      	<div class="input-field col s12">
						{!!Form::textarea('nombre', $productos->nombre, ['class'=>'validate', 'cols'=>'74', 'rows'=>'5'])!!}
				    </div>
				    <label class="col s12 " for="parrafo">Descipción</label>
			      	<div class="input-field col s12">
						{!!Form::textarea('descripcion', $productos->descripcion, ['class'=>'validate', 'cols'=>'74', 'rows'=>'5'])!!}
				    </div>
				</div>
